  ...
  return (
    <div className="m-12 md:m-16">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4 md:gap-6 items-stretch">
        {/* TEXT */}
        <div className="flex-1 flex flex-col justify-between items-stretch gap-4 md:gap-6">
        ...
        {/* MAP */}
        <div className="flex-1 xl:flex-[2] transition-all">
          <iframe 
            ...
            className="w-full h-full min-h-[400px] md:min-h-[500px] rounded-3xl"
            loading="lazy" 
          />
        </div>
