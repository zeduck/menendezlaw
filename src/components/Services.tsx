  ...
  return (
      <div className="m-12 md:m-16">
        ...
        <div className="flex flex-col justify-between gap-4 md:gap-6">
          ...
          <div onClick={toggleVisible1} className={`bg-primary text-primary_content rounded-3xl w-full p-4 md:p-8 hover:-translate-y-1 hover:bg-primary_focus hover:cursor-pointer break-words overflow-hidden ${!visible1 && 'max-h-24 md:max-h-[94px] lg:max-h-24'} ${visible1 && 'max-h-64'} transition-all`}>
            <h1 className="text-2xl lg:text-3xl"> { cards[0].title } </h1>
            <p className="text-lg md:text-xl pt-4 md:pt-6"> { cards[0].body } </p>
          </div>
          
          <div onClick={toggleVisible2} className={`bg-primary text-primary_content rounded-3xl w-full p-4 md:p-8 hover:-translate-y-1 hover:bg-primary_focus hover:cursor-pointer break-words overflow-hidden ${!visible2 && 'max-h-16 md:max-h-[94px] lg:max-h-24'} ${visible2 && 'max-h-64'} transition-all`}>
            <h1 className="text-2xl lg:text-3xl"> { cards[1].title } </h1>
            <p className="text-lg md:text-xl pt-4 md:pt-6"> { cards[1].body } </p>
          </div>
          
          <div onClick={toggleVisible3} className={`bg-primary text-primary_content rounded-3xl w-full p-4 md:p-8 hover:-translate-y-1 hover:bg-primary_focus hover:cursor-pointer break-words overflow-hidden ${!visible3 && 'max-h-24 md:max-h-[94px] lg:max-h-24'} ${visible3 && 'max-h-64'} transition-all`}>
            <h1 className="text-2xl lg:text-3xl"> { cards[2].title } </h1>
            <p className="text-lg md:text-xl pt-4 md:pt-6"> { cards[2].body } </p>
          </div>

          <div onClick={toggleVisible4} className={`bg-primary text-primary_content rounded-3xl w-full p-4 md:p-8 hover:-translate-y-1 hover:bg-primary_focus hover:cursor-pointer break-words overflow-hidden ${!visible4 && 'max-h-16 md:max-h-[94px] lg:max-h-24'} ${visible4 && 'max-h-64'} transition-all`}>
