...
export default function Contact() {
  return (
    <div className="m-12 md:m-16">
      ...
      <h1 className="text-5xl md:text-6xl pb-6 md:pb-8"> Contacto </h1>
      <p className="text-xl md:text-2xl pb-8 md:pb-12">¡Espero saber de ti!</p>
      ...
      <div className="flex flex-col w-full justify-start gap-5">
        ...
        <a href="tel:+16138608998" className="bg-primary text-primary_content hover:bg-primary_focus hover:-translate-y-1 transition-all rounded-3xl w-full p-6 md:p-8 text-xl md:text-2xl flex flex-row justify-start gap-2 sm:gap-4 items-center">
